...
get_filename_component(
    FOO
    bar/long_filename_______________________.ext
    PATH
    CACHE
)
...
get_filename_component(
    ...
    bar/long_filename_______________________.ext
    BASE_DIR
        long_base_dir________________________________________________________
    CACHE
)
...
get_filename_component(
    ...
    PROGRAM
    PROGRAM_ARGS
        long_arg_var______________________________________________________
    CACHE
)
