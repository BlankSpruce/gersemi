### {line_length: 120, list_expansion: favour-expansion}
...
find_program(foo_EXECUTABLE foo HINTS "${fooDirectory}" "${barDirectory}")
file(COPY foo bar DESTINATION "${CMAKE_CURRENT_BINARY_DIR}/foo")
list(APPEND foo "BAR" "BAZ")
set("${outputVar}" "${result}"  "${another_result}" PARENT_SCOPE)
...
find_package(Qt5 Qml QuickCompiler Qml)

find_package(Qt5 REQUIRED Qml)
find_package(Qt5 REQUIRED Qml QuickCompiler)
...
set(foo "bar" CACHE STRING "long                                                                                               docstring")
