...
file(
    ...
    RESOLVED_DEPENDENCIES_VAR foo
    UNRESOLVED_DEPENDENCIES_VAR foo
    CONFLICTING_DEPENDENCIES_PREFIX foo
    EXECUTABLES foo bar
    LIBRARIES foo bar
    MODULES foo bar
    DIRECTORIES foo bar
    BUNDLE_EXECUTABLE foo
    PRE_INCLUDE_REGEXES foo bar
    PRE_EXCLUDE_REGEXES foo bar
    POST_INCLUDE_REGEXES foo bar
    POST_EXCLUDE_REGEXES foo bar
)
...
file(
    ...
    RELATIVE bar
    CONFIGURE_DEPENDS
    long_glob_________________________
)
...
file(
    ...
    RELEASE
    GUARD FUNCTION
    RESULT_VARIABLE long_variable_name__________________________
    TIMEOUT 100
)
