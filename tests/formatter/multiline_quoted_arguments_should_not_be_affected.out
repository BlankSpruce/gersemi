# Quoted arguments shouldn't be affected by reformatting because their
...
set(OTHER_FORMATTED_PYTHON_CODE
    "Foo = lambda Bar: Bar.something_to_be_done_on_Bar_object()"
)
